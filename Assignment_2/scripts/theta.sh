...
#SBATCH -o /work/agro932/zfleming3/agro932/Assignment_2/cache/err_out/theta.out
#SBATCH -e /work/agro932/zfleming3/agro932/Assignment_2/cache/err_out/theta.err
#SBATCH -J theta #Job name
...
# sort
for i in *.bam; do samtools sort -@ 8 ${i} -o sorted_${i}.bam; done
